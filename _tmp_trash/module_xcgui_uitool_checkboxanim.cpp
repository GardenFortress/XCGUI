...
typedef int (CALLBACK* _XChk_MouseLeaveCallback)(HELE, HELE, BOOL*);
const _XChk_MouseLeaveCallback kXChk_MouseLeaveCallback = &CXCheckAnim::OnMouseLeaveC;
...
void _XChk_HookEvents(HELE hBtn, _XChk_Entry& e)
{
	...
	XEle_RegEventC1(hBtn, XE_MOUSELEAVE,   (void*)kXChk_MouseLeaveCallback);
...
void _XChk_UnhookEvents(HELE hBtn, _XChk_Entry& e)
{
	...
	XEle_RemoveEventC(hBtn, XE_MOUSELEAVE,   (void*)kXChk_MouseLeaveCallback);
